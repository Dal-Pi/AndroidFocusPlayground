 ...
 */
package com.kania.focusplayground.car.ui;
...
import com.kania.focusplayground.R;
...
//        setMeasuredDimension(1, 1);
    ...
    public void onWindowFocusChanged(boolean hasWindowFocus) {
        ...
        Log.d("kania", "parkingView hasWindowFocus: " + hasWindowFocus);
        setVisibility(hasWindowFocus ? INVISIBLE : VISIBLE);
